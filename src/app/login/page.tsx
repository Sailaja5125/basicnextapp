      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
          <div className="max-w-md mx-auto">
            <h1 className="text-5xl font-bold text-center cursor-default dark:text-gray-300 text-gray-900 m-5">Login</h1>
            <div className="mt-5">
              <label
              ...
              <input
                ...
                id="email"
                value={user.email}
                onChange={(evt)=>{setUser({...user  // to ensure that other values are not changed
         ...
         { Buttondisable==true?
              <button
                className="py-2 px-4 bg-gray-600  focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                type="submit"
                onClick={OnLogin}
                disabled
              >
